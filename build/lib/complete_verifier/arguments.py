...
class ConfigHandler:
    ...
    def add_common_options(self):
        ...
        self.add_argument("--tmp_cuts", default=None,
                          help='Automatically generated cuts if add_implied_cuts is True; otherwise one can feed manual cuts using this argument. The cut file should be named xxx.cuts.',
